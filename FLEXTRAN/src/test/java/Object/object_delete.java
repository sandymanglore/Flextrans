...
public class object_delete {
	...
	public static void main(String[] args) throws InterruptedException, IOException {
		...
		report = new ExtentReports(
				"C:\\Users\\Sandesh k. r\\eclipse-workspace\\FLEXTRAN\\src\\test\\java\\Object\\Object report./SanObject./Delete.html");

		test = report.startTest("Delete Object", "Delete");
		...
		driver.findElement(By.xpath(
				"//body[1]/div[1]/div[1]/div[1]/main[1]/div[2]/div[2]/div[1]/div[3]/div[1]/div[3]/div[18]/div[1]/div[1]/div[1]"))
				.click();
		...
		test.log(LogStatus.INFO, "User  able to Delete Object if we not  add Action to Object");
		Thread.sleep(3000);
		report.endTest(test);
		...
		js4.executeScript("window.scrollBy(0,50)");
		...
		test01.log(LogStatus.ERROR, "User Not able to Delete Object iF add Action to object");
		Thread.sleep(3000);
